...
var res = sforce.apex.execute("highlighter.getFieldIDs", "getIds", {objectName: 'Account',rtName: rtName}); 
								...
								if (layoutComponents[m].value != 'BillingAddress' && layoutComponents[m].value != 'ShippingAddress') {
									...
									if (detailLayoutSection[j].columns == 1 && layoutComponents[m].displayLines > 1 && field.type=='textarea') {
										if (layoutItems[l].required == 'true') {
											divNum++;
											body += '\\n\\t\\t\\t\\t<apex:inputField id=\''+idVal+'\' value=\'\{\!Account.' + layoutComponents[m].value + '}\' required=\'' + layoutItems[l].required + '\' tabOrderHint=\'' + layoutComponents[m].tabOrder + '\' style=\'width:473px;height:50px;\' onkeypress=\'noenter(event)\' styleClass=\'reqClass\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t\\t<div id=\'div' + divNum + '\' style=\'color:#d74c3b;display:none;\' class=\'errorMsg\'>Error: You must enter a value</div>\\n\\t\\t\\t\\t</apex:inputField>';
										} else {
											body += '\\n\\t\\t\\t\\t<apex:inputField id=\''+idVal+'\' value=\'\{\!Account.' + layoutComponents[m].value + '}\' required=\'' + layoutItems[l].required + '\' tabOrderHint=\'' + layoutComponents[m].tabOrder + '\' style=\'width:473px;height:50px;\' onkeypress=\'noenter(event)\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t</apex:inputField>';
										}
									} else {
										if (layoutComponents[m].value == 'OwnerId') {
											...
											if (layoutItems[l].required == 'true') {
												divNum++;
												body += '\\n\\t\\t\\t\\t<apex:inputField id=\''+idVal+'\' value=\'\{\!Account.' + layoutComponents[m].value + '}\' required=\'' + layoutItems[l].required + '\' tabOrderHint=\'' + layoutComponents[m].tabOrder + '\' onkeypress=\'noenter(event)\' styleClass=\'reqClass\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t\\t<div id=\'div' + divNum + '\' style=\'color:#d74c3b;display:none;\' class=\'errorMsg\'>Error: You must enter a value</div>\\n\\t\\t\\t\\t</apex:inputField>';
											} else {
												body += '\\n\\t\\t\\t\\t<apex:inputField id=\''+idVal+'\' value=\'\{\!Account.' + layoutComponents[m].value + '}\' required=\'' + layoutItems[l].required + '\' tabOrderHint=\'' + layoutComponents[m].tabOrder + '\' onkeypress=\'noenter(event)\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t</apex:inputField>';
											}
										}
									}
									...
									if(layoutItems[l+1] != undefined){
										if(layoutItems[l+1].label=='Shipping Address' || layoutItems[l+1].label=='Billing Address'){
											addressSet = true;
											...
											for(var p=0;p<addressComponents.length;p++){
												...
												if (layoutItems[l].required == 'true') {
													divNum++;													
													body += '\\n\\t\\t\\t\\t<apex:inputField id=\''+addrIdVal+'\' value=\'\{\!Account.' + addressComponents[p].value + '}\' required=\'' + layoutItems[l].required + '\' tabOrderHint=\'' + addressComponents[p].tabOrder + '\' onkeypress=\'noenter(event)\' styleClass=\'reqClass\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t\\t<div id=\'div' + divNum + '\' style=\'color:#d74c3b;display:none;\' class=\'errorMsg\'>Error: You must enter a value</div>\\n\\t\\t\\t\\t</apex:inputField>\\n\\t\\t\\t\\t<apex:inputField value=\'\{\!Account.' + addressTwoComponents[p].value + '}\' required=\'' + layoutItems[l+1].required + '\' tabOrderHint=\'' + addressTwoComponents[p].tabOrder + '\' onkeypress=\'noenter(event)\' styleClass=\'reqClass\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t\\t<div id=\'div' + divNum + '\' style=\'color:#d74c3b;display:none;\' class=\'errorMsg\'>Error: You must enter a value</div>\\n\\t\\t\\t\\t</apex:inputField>';
												} else {
													body += '\\n\\t\\t\\t\\t<apex:inputField id=\''+addrIdVal+'\' value=\'\{\!Account.' + addressComponents[p].value + '}\' required=\'' + layoutItems[l].required + '\' tabOrderHint=\'' + addressComponents[p].tabOrder + '\' onkeypress=\'noenter(event)\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t</apex:inputField>\\n\\t\\t\\t\\t<apex:inputField value=\'\{\!Account.' + addressTwoComponents[p].value + '}\' required=\'' + layoutItems[l+1].required + '\' tabOrderHint=\'' + addressTwoComponents[p].tabOrder + '\' onkeypress=\'noenter(event)\'>\\n\\t\\t\\t\\t\\t<apex:actionSupport event=\'onkeyup\' rerender=\'pg\'/>\\n\\t\\t\\t\\t</apex:inputField>';
												}
											}							
										} 
									}
